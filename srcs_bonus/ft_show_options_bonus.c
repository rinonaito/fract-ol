...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/05/26 15:57:25 by rnaito            #+#    #+#             */
/*   Updated: 2023/05/26 17:19:17 by rnaito           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_show_options2(int argc)
{
	...
	if (argc < 3)
		...
		ft_printf("Invalid parameter.\n");
	ft_printf("Please retry with the following options.\n");
	ft_printf("Give a number between 1 to 4 as the 3nd parameter.\n\n");
}
